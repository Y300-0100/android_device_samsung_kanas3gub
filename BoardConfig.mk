...
# RIL
BOARD_RIL_CLASS := ../../../device/samsung/kans3gub/ril
COMMON_GLOBAL_CFLAGS += -DSEC_PRODUCT_FEATURE_RIL_CALL_DUALMODE_CDMAGSM

# Bluetooth
BOARD_HAVE_BLUETOOTH := true
BOARD_HAVE_BLUETOOTH_BCM := true
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/samsung/kanas3gub/bluetooth
BOARD_BLUEDROID_VENDOR_CONF := device/samsung/kanas3gub/bluetooth/libbt_vndcfg.txt
...
BOARD_EGL_CFG := device/samsung/kanas3gub/configs/egl.cfg
...
TARGET_KERNEL_SOURCE := kernel/samsung/kanas3gub

# Init
TARGET_NR_SVC_SUPP_GIDS := 48

# Assert
TARGET_OTA_ASSERT_DEVICE := kanas3gub,SM-G355M,kanas,SM-G355M

# SELinux
BOARD_SEPOLICY_DIRS += device/kanas3gub/sepolicy
...
# CMHW
BOARD_HARDWARE_CLASS := hardware/samsung/cmhw/ device/samsung/kanas3gub/cmhw/
